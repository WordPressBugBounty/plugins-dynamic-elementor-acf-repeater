...
class AdminSettingsNotices {
    ...
    public static function init() {
        ...
        add_filter('plugin_action_links_' . plugin_basename(DYNAMIC_ELEMENTOR_ACF_REPEATER_PLUGIN_FILE), [self::class, 'add_plugin_action_links']);
        add_action('admin_menu', [self::class, 'add_menu_page'], 20);
        add_action('admin_menu', [self::class, 'remove_main_menu_page'], 99);
    }
    ...
    public static function render_settings_page() {
        ...
        <div class="wrap">
            ...
            $template_path = plugin_dir_path(dirname(__FILE__)) . 'admin/partials/getting-started.php';
    ...
    private static function is_activation_request() {
        return isset($_GET['activate']) && wp_verify_nonce(wp_create_nonce('activate-plugin_' . plugin_basename(DYNAMIC_ELEMENTOR_ACF_REPEATER_PLUGIN_FILE)));
    }
